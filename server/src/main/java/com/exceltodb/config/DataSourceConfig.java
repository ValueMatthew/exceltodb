...
public class DataSourceConfig {
    ...
    private DataSource createDataSource(String databaseId) {
        ...
        config.setJdbcUrl(String.format("jdbc:mysql://%s:%d/%s?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true&allowLoadLocalInfile=true",
